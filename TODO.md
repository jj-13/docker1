...
si se ejecuta el compose directamente no genera ningun error pero al ejucatarlo desde el archivo example_docker.sh es que no genera el network del app